    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-12 text-left">
            <div className="space-y-4">
              <div className="w-12 h-1 bg-[#071B3A] rounded" />
            ...
            <div className="space-y-8">
              {pillars.map((p, idx) => (
                <div key={idx} className="flex gap-6 items-start border-l-2 border-slate-100 pl-6 hover:border-[#071B3A] transition-colors">
          ...
          <div className="lg:col-span-7 bg-white text-slate-900 p-6 md:p-8 rounded-2xl border border-slate-200 shadow-xl flex flex-col justify-between space-y-6">
            <div className="flex flex-col md:flex-row gap-6 items-start text-left">
              ...
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-2xl overflow-hidden border-2 border-slate-900 bg-slate-950 relative flex items-center justify-center shrink-0 shadow-lg">
                <div className="absolute inset-0 bg-gradient-to-tr from-[#071B3A] to-sky/30 flex flex-col items-center justify-center p-4 text-center">
            ...
            <Link
              ...
              className="bg-slate-900 hover:bg-[#071B3A] text-white font-bold py-3.5 px-6 rounded-none text-xs uppercase tracking-wider transition-all text-center flex items-center justify-center gap-2 cursor-pointer border border-transparent shadow-md"
            >
      ...
      < section className="py-20 px-6 md:px-12 max-w-7xl mx-auto w-full text-center space-y-8" >
        ...
        <Link
          ...
          className="inline-flex items-center bg-[#071B3A] hover:bg-slate-950 text-white font-bold py-3.5 px-6 rounded-none text-xs uppercase tracking-wider transition-all duration-300 shadow-lg group border border-[#071B3A]"
        >
