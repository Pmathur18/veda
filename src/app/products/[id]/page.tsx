  ...
  if (!product) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center space-y-4 px-4 text-center">
        ...
        <p className="text-slate-555 text-sm max-w-md">
          The requested natural ingredient ID does not exist in our active trade lanes registry.
        </p>
        <Link
          href="/products"
          className="inline-flex items-center gap-2 bg-brand text-white text-xs font-bold px-6 py-3.5 rounded-none uppercase tracking-wider hover:bg-brand-hover transition-all border border-transparent"
        >
