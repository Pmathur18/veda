...
export const metadata: Metadata = {
  ...
  description: "Source premium Psyllium Husk (99%, 98%, 95%), Psyllium Powder (40-100 Mesh), and Senna Leaves (Prime Cut, Pods) directly from India with custom packaging and COA.",
  keywords: [
